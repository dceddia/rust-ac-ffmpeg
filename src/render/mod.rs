...
extern "C" {
    ...
    fn gl_renderer_render(
        renderer: *mut c_void,
        cv_pixel_buffer_ref: *mut c_void,
        sampler_y_location: c_int,
        sampler_uv_location: c_int,
    ) -> c_int;
...
impl GlRenderer {
    ...
    pub fn render(
        &self,
        frame: &VideoFrame,
        sampler_y_location: u32,
        sampler_uv_location: u32,
    ) -> Result<(), Error> {
        ...
        let res = unsafe {
            gl_renderer_render(
                self.ptr,
                pixel_buffer as _,
                sampler_y_location as _,
                sampler_uv_location as _,
            )
        };
